...
\definecolor{- }{RGB}{175,5,170}
\definecolor{pink}{RGB}{234,33,162}
...
\b{document}
   \b{center}
       \vspace*{12cm}
       \tb{{\Huge HS101 {\color{- }kinda} Short Notes}}
...
\b{itemize}
    \i \tb{economy} - comes from Greek word {\color{pink}oikonomos} - means ``one who manages a household"
...
\setcounter{enumi}{4}
    ...
    \b{itemize}
        ...
        \i Adam Smith in his book \emph{An Inquiry into the Nature and Causes of the Wealth of Nations} said households and firms interacting in markets act as if they are guided by an {\color{pink}`invisible hand'} that leads them to desirable market outcomes
    ...
    \begin{itemize}
        \i The invisible hand can work its magic only if the government enforces the rules and maintains the institutions that are key to a market economy. Market economies need institutions to enforce {\color{pink}property rights} so individuals can own and control scarce resources.
        \i \tb{property rights} - the ability of an individual to own and exercise control over scarce resources
        \i There are two broad reasons for a government to intervene in the economy and change the allocation of resources that people would choose on their own: {\color{pink}to promote efficiency or to promote equality}
...
\setcounter{enumi}{7}
    ...
    \b{itemize}
        \i Almost all variation in living standards is attributable to differences in countries' {\color{pink}productivity}
...
\b{itemize}
    ...
    \i An outcome is said to be {\color{pink}efficient} if the economy is getting all it can from the scarce resources it has available. Points on (rather than inside) the production possibilities frontier represent efficient levels of production.
...
\b{itemize}
    ...
    \i \tb{positive statements} - claims that attempt to describe the world as it is. Positive statements are {\color{pink}descriptive.}
    \i \tb{normative statements} - claims that attempt to prescribe how the world should be. Normative statements are {\color{pink}prescriptive.}
\e{itemize}
...
\b{itemize}
    ...
    \e{itemize}
    \i A shift in the supply curve is called a {\color{pink}change in supply}, and a shift in demand curve is called a {\color{pink}change in demand}. A movement along a fixed supply curve is called a {\color{pink}change in the quantity supplied}, and a movement along a fixed demand curve is called a {\color{pink}change in the quantity demanded.}
    \begin{figure}[H]
    \centering
...
\b{itemize}
    ...
    \i Demand is considered {\color{pink}elastic} when the elasticity is greater than 1, which means the quantity moves proportionately more than the price. Demand is considered {\color{pink}inelastic} when the elasticity is less than 1, which means the quantity moves proportionately less than the price. If the elasticity is exactly equal to 1, the quantity moves the same amount proportionately as the price, and demand is said to have {\color{pink}unit elasticity.}
    \begin{figure}[H]
    \centering
...
\b{itemize}
    ...
    \i If the price that balances supply and demand is below the ceiling, the price ceiling is {color{pink}not binding}. Market forces naturally move the economy to the equilibrium, and the price ceiling has no effect on the price or the quantity sold. If the price is above the ceiling, the price ceiling is a {\color{pink}binding} constraint on the market.
    ...
    \i If the equilibrium price is above the floor, the price floor is {color{pink}not binding}. Market forces naturally move the economy to the equilibrium, and the price floor has no effect. If the price is below the floor, the price floor is a {\color{pink}binding} constraint on the market.
...
\b{itemize}
    \i {\color{pink}Taxes} are used to raise revenue for public projects, such as roads, schools, and national defense
...
\b{itemize}
    ...
    \i The point at which the indifference curve and the budget constraint touch is called the {\color{pink}optimum}
    \begin{figure}[H]
    \centering
...
\b{itemize}
    \i A firm is an organization that comes into being when a person or a group of people decides to produce a good or a service. A Firm can be organized in the form of {\color{pink}sole proprietorship, partnership} or {\color{pink}corporation.} Firms can be classified in terms of {\color{pink}single} or {\color{pink}multiple product firms}. They can also be classified in terms of {\color{pink}domestic} and {\color{pink}multinationals.}
    \i A competitive market is also called a {\color{pink}perfectly competitive market}. It has three characteristics:
    \b{itemize}
    ...
    \e{itemize}
    \i Buyers and sellers in competitive markets must accept the price the market determines and, therefore, are said to be {\color{pink}price takers}
    ...
    \end{figure}
    \i A {\color{pink}shutdown} refers to a short-run decision not to produce anything during a specific period of time because of current market conditions
    \i {\color{pink}Exit} refers to a long-run decision to leave the market
